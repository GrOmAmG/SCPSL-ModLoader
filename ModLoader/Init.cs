...
namespace ModLoader
{
    ...
    {
        public const string ModLoaderVersion = "v0.0.1";
        ...
        public static void Start()
        {
            ...
            HarmonyInstance.Create("grom_amg.modloader")?.PatchAll(Assembly.GetExecutingAssembly());
        ...
        private static DirectoryInfo GetModsDirectory()
        {
            ...
            {
                baseDirectory = dataDir.Parent?.Parent;
            }
            else if (Application.platform == RuntimePlatform.LinuxPlayer)
            {
                baseDirectory = dataDir.Parent;
            }
            else
            {
                baseDirectory = dataDir.Parent;
            ...
            ModLogger.WriteLine("Path to mods is: " + Path.Combine(baseDirectory?.FullName, "Mods"));
            return new DirectoryInfo(Path.Combine(baseDirectory?.FullName, "Mods"));
        }
